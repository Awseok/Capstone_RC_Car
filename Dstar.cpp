...
extern "C" {
    ...
    void init(Dstar* dstar, int start_x, int start_y, int end_x, int end_y)
    {
        dstar->init(start_x, start_y, end_x, end_y);
    }

    void updateCell(Dstar* dstar, int x, int y, int value)
    {
        dstar->updateCell(x, y, value);
    }

    void replan(Dstar* dstar)
    {
        dstar->replan();
    }

    list<state> getPath(Dstar* dstar)
    {
        return dstar->getPath();
    }

    void updateGoal(Dstar* dstar, int x, int y)
    {
